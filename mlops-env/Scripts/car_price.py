...
st.subheader("Predict the price of your car based on its features!")
...
if st.button("Predict Price"):
    ...
    input_features = input_data = [[2012.0, 2, 120000,encoded_fuel_type, encoded_transmission_type,19.7,engine,46.3,seats]]
    prediction = model.predict(input_features)
    st.header(f"The predicted price of the car is: ₹{prediction[0]:.2f} Lakhs")    